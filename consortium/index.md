...
![PMQ]({{ site.url }}/images/logos/PMQ.gif){: .company-logo } **Peterstaler Mineralquellen GmbH (PMQ)**

![CES]({{ site.url }}/images/logos/CES.png){: .company-logo } **C. Ed. Schulte GmbH Zylinderschlossfabrik (CES)**
...
![KHS]({{ site.url }}/images/logos/KHS.jpg){: .company-logo } **KHS GmbH (KHS)**

![SITEC]({{ site.url }}/images/logos/SITEC.png){: .company-logo } **SITEC Industrietechnologie GmbH (SITEC)**
...
![N+P]({{ site.url }}/images/logos/N+P.jpg){: .company-logo } **N+P Informationssysteme GmbH (N+P)**
