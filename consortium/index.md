...
![PMQ]({{ site.url | replace: 'http://', '//' }}/images/logos/PMQ.gif){: .company-logo } 
...
![CES]({{ site.url | replace: 'http://', '//' }}/images/logos/CES.png){: .company-logo } 
...
![CPT]({{ site.url | replace: 'http://', '//' }}/images/logos/CPT.jpg){: .company-logo } 
...
![KHS]({{ site.url | replace: 'http://', '//' }}/images/logos/KHS.jpg){: .company-logo } 
...
![SITEC]({{ site.url | replace: 'http://', '//' }}/images/logos/SITEC.png){: .company-logo } 
...
![HREC]({{ site.url | replace: 'http://', '//' }}/images/logos/HREC.png){: .company-logo }
...
![N+P]({{ site.url | replace: 'http://', '//' }}/images/logos/N+P.jpg){: .company-logo } 
...
![n3]({{ site.url | replace: 'http://', '//' }}/images/logos/n3.png){: .company-logo } 
...
![TTI]({{ site.url | replace: 'http://', '//' }}/images/logos/TTI.png){: .company-logo } 
...
![IWU]({{ site.url | replace: 'http://', '//' }}/images/logos/IWU.png){: .company-logo } 
...
![IUMS]({{ site.url | replace: 'http://', '//' }}/images/logos/IUMS.png){: .company-logo } 
...
![ATB]({{ site.url | replace: 'http://', '//' }}/images/logos/ATB.gif){: .company-logo } 
